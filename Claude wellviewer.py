"""
WellViewer — Visualizador 3D Generico de Pozos  v1.0
=====================================================
...
---
*WellViewer v1.0 | Portfolio Ingenieria de Yacimientos | Streamlit + Plotly*
""")

st.markdown("---")
st.markdown(
    "<center><small>WellViewer v1.0 | Generador generico de pozos 3D | "
